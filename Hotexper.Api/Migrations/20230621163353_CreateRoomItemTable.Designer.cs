...
namespace Hotexper.Api.Migrations
{
    ...
    [Migration("20230621163353_CreateRoomItemTable")]
    partial class CreateRoomItemTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hotexper.Domain.Entities.Hotel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Hotexper.Domain.Entities.HotelImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hotexper.Domain.Entities.HotelImage", b =>
                {
                    b.HasOne("Hotexper.Domain.Entities.Hotel", "Hotel")
            ...
            modelBuilder.Entity("Hotexper.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.HasOne("Hotexper.Domain.Entities.User", "User")
                        .WithMany("Reservations")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Hotexper.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
